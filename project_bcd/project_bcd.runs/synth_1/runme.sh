...
HD_PWD='C:/Users/dazhouliu/Desktop/490Retro/project_bcd/project_bcd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log segdisplay_multi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source segdisplay_multi.tcl
