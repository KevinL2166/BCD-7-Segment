...
HD_PWD='C:/Users/dazhouliu/Desktop/490Retro/project_bcd/project_bcd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log segdisplay_multi.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source segdisplay_multi.tcl -notrace
